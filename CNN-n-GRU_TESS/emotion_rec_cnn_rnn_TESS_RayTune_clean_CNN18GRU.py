...
def main(num_samples=10, max_num_epochs=10, gpus_per_trial=1):
    ...
    result = tune.run(
        ...
        local_dir=os.path.abspath(tess_experiments_folder+"/TESS_CNN_18_GRU"),
        log_to_file=(os.path.abspath(tess_experiments_folder+"/TESS_CNN_18_GRU_stdout.log"), os.path.abspath(tess_experiments_folder+"/TESS_CNN_18_GRU_stderr.log")),
        name="TESS_CNN_18_GRU",
        resume='AUTO')
