...
class CNN18GRU(nn.Module):
    def __init__(self, n_input, hidden_dim, n_layers, n_output=len(wordclasses), stride=4, n_channel=18):
        super().__init__()
...
def main(num_samples=10, max_num_epochs=10, gpus_per_trial=1):
    ...
    result = tune.run(
        ...
        local_dir=os.path.abspath(iemocap_experiments_folder+"/IEMOCAP_CNN_18_GRU"),
        log_to_file=(os.path.abspath(iemocap_experiments_folder+"/IEMOCAP_CNN_18_GRU_stdout.log"), os.path.abspath(iemocap_experiments_folder+"/IEMOCAP_CNN_18_GRU_stderr.log")),
        name="IEMOCAP_CNN_18_GRU",
        resume='AUTO')
