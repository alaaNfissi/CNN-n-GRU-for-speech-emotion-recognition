...
def main(num_samples=10, max_num_epochs=10, gpus_per_trial=1):
    ...
    result = tune.run(
        ...
        local_dir=os.path.abspath(iemocap_experiments_folder+"/IEMOCAP_CNN_11_GRU"),
        log_to_file=(os.path.abspath(iemocap_experiments_folder+"/IEMOCAP_CNN_11_GRU_stdout.log"), os.path.abspath(iemocap_experiments_folder+"/IEMOCAP_CNN_11_GRU_stderr.log")),
        name="IEMOCAP_CNN_11_GRU",
        resume='AUTO')
