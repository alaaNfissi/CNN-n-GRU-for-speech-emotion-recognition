...
class CNN3GRU(nn.Module):
    def __init__(self, n_input, hidden_dim, n_layers, n_output=len(wordclasses), stride=4, n_channel=3):
        super().__init__()
...
def main(num_samples=10, max_num_epochs=10, gpus_per_trial=1):
    ...
    result = tune.run(
        ...
        local_dir=os.path.abspath(iemocap_experiments_folder+"/IEMOCAP_CNN_3_GRU"),
        log_to_file=(os.path.abspath(iemocap_experiments_folder+"/IEMOCAP_CNN_3_GRU_stdout.log"), os.path.abspath(iemocap_experiments_folder+"/IEMOCAP_CNN_3_GRU_stderr.log")),
        name="IEMOCAP_CNN_3_GRU",
        resume='AUTO')
